...
{
    /// <summary>
    /// 캠페인 씬 전용 턴 넘기기 버튼 컴포넌트입니다.
    /// 기본모드는 HoldToAdvanceTurn을 사용하세요.
    ///
    /// ─── 기본모드와의 차이 ───────────────────────────────────────────────────
    ...
    public class CampaignHoldToAdvanceTurn : MonoBehaviour
    {
        ...
        public void BeginHold()
        {
            ...
            var playerAction = CampaignGameFlowController.Instance?.GetPlayerActionState();
        ...
        private void OnFillComplete()
        {
            ...
            ConfirmPanel.Instance?.Show(_confirmMessage,
                onConfirm: () =>
                {
                    ...
                    HideFill();
                    // ★ CampaignGameFlowController 참조
                    CampaignGameFlowController.Instance?.ForceEndTurn();
                },
                onCancel: () =>
                {
                    _triggered = false;
